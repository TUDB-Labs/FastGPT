    ...
    <div class="web main-box">
      <div class="type-list">
        <div
          ...
          :key="typeIndex"
          class="type-item"
          :class="{ active: selectTypeItem.name === typeItem.name }"
          @click="selectTypeItem = typeItem"
        >
          <div class="type">
            <strong>{{ typeItem.name }}</strong>
            <i
      ...
      <div class="demo-list">
        <div
          v-for="(item, index) in selectTypeItem.children"
          :key="index"
          class="demo-item"
        >
          <div>
...
export default {
  ...
  data() {
    return {
      ...
      sliding: null,
      //demo
      newDemoObjList: newDemoObjList,
      curTabIndex: 0,
      selectTypeItem: newDemoObjList[0],
    };
  },
  created() {},
  mounted() {
  ...
  methods: {
    ...
    showDemoDetail(item) {
      if (item.path) {
        ...
        window.open(location.origin +'/'+item.path, "_blank");
      } else {
